...
int main()
{
    ...
    //int tab[] = {1,2,3, 4, 5, 6, 7, 1, 3, 2}; // Déclaration et initialisation du tableau - connexe
    //int tab[] = {15, 3}; // Déclaration et initialisation du tableau - connexe
    int tab[] = {1, 2,9,10,8,9,7,8,6,7,5,6,4,5,3,4,2, 3}; // Déclaration et initialisation du tableau - connexe
    ...
    // int tab[] = {19, 2, 3, 90, 4, 3, 4, 5, 5, 3}; // Déclaration et initialisation du tableau - connexe
